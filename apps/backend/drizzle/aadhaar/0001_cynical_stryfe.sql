CREATE TABLE `aadhaar_transactions` (
	...
	`users_kyc_id` varchar(36) NOT NULL,
...
DROP TABLE `aadhaar_sessions`;--> statement-breakpoint
DROP TABLE `aadhaar_callbacks`;--> statement-breakpoint
DROP TABLE `aadhaar_fee_transactions`;--> statement-breakpoint
